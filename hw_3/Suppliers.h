...
{
    long long business_num;
    char supplier_name[5];
    char phone_num[10];
    unsigned int num_of_transactions;
    unsigned int total_sum_of_transactions;
} Supplier;

/*Generates and initializes an array of suppliers
*
* return : returns an array of suppliers*/
Supplier createSupplierList[]();

            ...
            switch(choice)
            {
                ...
                case 5 :
                {
                    if(clientTree->root != NULL)
                    {
                        ...
                        if(clientList == NULL || clientList->root == NULL) printf("\nNo clients to show\n");
                        else
                        {
                            TreeNode* scan;
                            scan = clientList->root;
                            printf("\n");
                            while(scan != NULL)
                            {
                                printClient(*((Client*)scan->value));
                                scan = scan->right;
                            }
                            scan = NULL;
                        }
        ...
        while(choice != 7)
        {
            ...
            switch(choice)
            {
                ...
                case 3 :
                {
                    ...
                    {
                        char suppliers[3][11];
                        threeGreatestSuppliers(tree,suppliers);
                ...
                case 4 :
                {
                    if(tree->root != NULL)
                    {
                        ...
                        printf("\nAverage of supplier money is : %0.2Lf NIS\n",average);
                    }
                    else printf("\nTree empty\n");
                    break;
                }
...
int DEMO()
{
    ...
    addNewClient(clients,"Uri","Spector","072780932","8970159",generate_date(2021,5,5),generate_time(0,0),250);
    addNewClient(clients,"Zion","Rubinstein","282891864","6922258",generate_date(2021,5,5),generate_time(8,0),235);
    addNewClient(clients,"Eliora","Laski","306466189","1209865",generate_date(2021,5,5),generate_time(23,59),180);
    addNewClient(clients,"Liora","Rivlin","204406587","1209865",generate_date(2021,5,5),generate_time(23,59),180);
    ...
    addNewSupplier(suppliers,"5604846475","Schnapp","0537981973",21,2500000);
